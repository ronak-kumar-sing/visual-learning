...
export const cdnLesson: Lesson = {
  ...
  steps: [
    {
      narration:
        "Step 1: Without CDN (Direct Origin). A user in Tokyo requests a 2MB video from an Origin server in Virginia. High cross-Pacific latency (190ms).",
      activeLine: 11,
      state: {
    ...
    {
      narration:
        "Step 2: With CDN Edge PoP (Cache Hit). Tokyo user queries Anycast DNS. Request is terminated at the local Tokyo Edge PoP in 12ms!",
      activeLine: 8,
      state: {
